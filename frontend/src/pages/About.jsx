...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <br />
      <span>
        Nitish Kumar is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Nitish is a big fan of cricket and
        holds immense admiration for <strong> Rohit Sharma.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Nitish.</strong> Their friendly rivalry and deep bond have
        significantly shaped Nitish’s journey. Nitish is not only a great
        competitor but also a steadfast friend, constantly motivating Nitish to
